...
function addDisco(event) {
  ...
  if (
    horizontal(linhaAtual) === true ||
    condicaoVitoriaVertical(linhaAtual) === true ||
    diagonalSubindo(linhaAtual) === true ||
    diagonalDescendo(linhaAtual) === true
  ) {
...
function horizontal(linha) {
  ...
  if (
    tabelaArray[0][posicao] !== undefined &&
    ...
    tabelaArray[1][posicao] !== undefined &&
    ...
    tabelaArray[2][posicao] !== undefined &&
    ...
    tabelaArray[3][posicao] !== undefined &&
...
function jogadorAtual(bolinhaCriada) {
  // a cada jogada será chamada essa função que intercalará a vez do jogador
  if (vezDoVermelho === true) {
